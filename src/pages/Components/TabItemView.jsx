...
class TabItemTitle extends React.Component {
    ...
    render() {
        ...
        return (
            <HighlightLabel className={className} keyword={this.props.keyword}>{this.props.tab.title}</HighlightLabel>
        )
    }
}
...
class TabItemUrl extends React.Component {
    render() {
        ...
        return <HighlightLabel className={className} keyword={this.props.keyword}>{this.props.tab.url}</HighlightLabel>
    }
}
